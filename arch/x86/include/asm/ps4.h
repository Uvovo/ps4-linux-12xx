...
extern int bpcie_icc_cmd(u8 major, u16 minor, const void *data,
			 u16 length, void *reply, u16 reply_length);
extern int bpcie_sata_phy_init(struct pci_dev *pdev, void __iomem *ahci_mmio);
...
static inline void icc_reboot(void)
{
}
...
static inline int bpcie_sata_phy_init(struct pci_dev *pdev, void __iomem *ahci_mmio)
{
	return -ENODEV;
}
